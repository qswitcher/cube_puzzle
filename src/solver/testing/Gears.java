...
public class Gears implements GLEventListener {
  ...
  public void init(GLAutoDrawable drawable) {
    System.out.println("Gears: Init: "+drawable);
    // Use debug pipeline
    ...
    if(0>=gear2) {
        ...
        gl.glEndList();
        System.out.println("gear2 list created: "+gear2);
    } else {
        System.out.println("gear2 list reused: "+gear2);
    }
    ...
    if(0>=gear3) {
        ...
        gl.glEndList();
        System.out.println("gear3 list created: "+gear3);
    } else {
        System.out.println("gear3 list reused: "+gear3);
    }
  ...
  public void reshape(GLAutoDrawable drawable, int x, int y, int width, int height) {
    System.out.println("Gears: Reshape "+x+"/"+y+" "+width+"x"+height);
    GL2 gl = drawable.getGL().getGL2();
